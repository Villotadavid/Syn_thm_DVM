	...
	for k in range (0,number_exp):
		...
		try:
			...
			for fr in range (0,number_files):
				...
				#collision=(160000-len(regression_points))/160000.0
				SteerX=(posx-200)/200.0
				SteerY=(posy-200)/200.0
				#print SteerX


				#cd ,,cv2.circle(stereo,(p_obj[1],p_obj[0]),10,(255,255,255),2)
