...
def _main():
    ...
    fname_steerX = os.path.join(FLAGS.experiment_rootdir, 'predicted_and_real_Y.json')
    with open(fname_steerX,'r') as f1:
        dict_steeringsY = json.load(f1)
    make_and_save_histogramsY(dict_steeringsY['pred_Y'], dict_steeringsY['real_Y'],
                             os.path.join(FLAGS.experiment_rootdir, "histogramsY.png"))
