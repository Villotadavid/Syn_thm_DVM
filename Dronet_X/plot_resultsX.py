...
def _main():
    ...
    fname_steerY = os.path.join(FLAGS.experiment_rootdir, 'predicted_and_real_X.json')
    with open(fname_steerY,'r') as f1:
        dict_steeringsX = json.load(f1)
    make_and_save_histogramsX(dict_steeringsX['pred_X'], dict_steeringsX['real_X'],
                             os.path.join(FLAGS.experiment_rootdir, "histogramsX.png"))
